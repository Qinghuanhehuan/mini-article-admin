  ...
  <div class="login-container">
    <el-form class="login-form" ref="form" :model="form" :rule="rules">
      ...
      <el-form-item prop="captcha" class="email-code">
        ...
        <el-input ref="captcha" v-model="form.captcha" placeholder="验证码" name="captcha"></el-input>
      </el-form-item>
      ...
      <el-form-item prop="nickname">
        ...
        <el-input ref="nickname" v-model="form.nickname" placeholder="密码" name="nickname"></el-input>
      </el-form-item>
